...
\subsection{\fagr{} har til formål at virke til gavn for de studerende i Faggruppen ved at varetage deres fælles faglige, økonomiske og sociale interesser.}\label{formaal:gavn}
...
\subsection{Ekstaordinær generalforsamling kan til enhver tid indkaldes med 14 dages varsel, når do tredjedeles flertal af de indvalgte stiller krav herom. Der indgives skriftlig begæring til forpersonen, som herefter forestår indkaldelse i overensstemmelse med stk. \ref{formaal:gavn}.}
...
\subsection{Kun studerende under Faggruppen kan opstille til valg i henhold til §\ref{gfi}, stk. \ref{gfi:dagsorden}, nr. 5, litra a-e. Opstilling kan se fysisk umiddelbart indene valget eller på forhånd ved skriftlig tilkendegivelse til forpersonen.}

\subsection{Valg i henhold til §\ref{gfi}, stk. \ref{gfi:dagsorden}, nr. 5 afholdes ved simpelt flertal via håndsoprækning. En eller flere stemmeberettigede kan begære skriftlig og hemmelig afstemning.}

\subsection{En person, der er valgt til én post i henhold til §\ref{gfi}, stk. \ref{gfi:dagsorden}, nr. 5 kan ikke vælges til andre poster. Valgte i henhold til §\ref{gfi}, stk. \ref{gfi:dagsorden}, nr., litra a-e, benævnes indvalgte.}

\subsection{Dirigenten orienterer Studenterrådets Dirigentinstitution om generalforsamlingens valg af posterne beskrevet i §\ref{gfi}, stk. \ref{gfi:dagsorden}, nr. 5, litra a-c.}
...
\item Meddelelser fra:
	...
	\end{enumerate}
\item Valg af menigt indvalgte efter proceduren i § \ref{gf}, stk. 6-8
